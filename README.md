...
### CUSTOM OPTION ADDED IN THIS VERSION

This fork of the pipeline includes an addtitional choice for the `--protocol` parameter called _scDiscoveries_ if you choose `--aligner star`. It specifies additional UMI+Barcode specific parameters that are used when your input data was generated by the [scDiscoveries SORT-SEQ](https://www.scdiscoveries.com/services/sort-seq/) method.
